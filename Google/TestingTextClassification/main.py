...
data2 = load_rotten_tomatoes_sentiment_analysis_dataset(mypath)
acc2, loss2 = train_sequence_model(data2)
assert acc2 == pytest.approx(0.68, 0.02)
assert loss2 == pytest.approx(0.82, 0.02)