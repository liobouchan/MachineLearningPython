...
# Working directory
setwd('C:/Users/LeonardoBouchan/Code/MachineLearningPython/TextClassificationTowarsDataScience/1CreateDataSet')

# Path definition of the news archives
path <- 'C:/Users/LeonardoBouchan/Code/MachineLearningPython/TextClassificationTowarsDataScience/bbc-fulltext/bbc'
...
df_final <- df_final %>% mutate(Complete_Filename = paste(File_Name, Category, sep='-'))
